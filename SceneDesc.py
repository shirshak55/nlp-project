...
from keras.layers import LSTM, Embedding, TimeDistributed, Dense, RepeatVector, Activation, Concatenate, Merge
...
class scenedesc():
    def __init__(self):
        ...
        self.image_encodings = pickle.load(
            open("image_encodings.p", "rb"), encoding='latin1')
        self.captions = None
        self.img_id = None
        self.values()
                ...
                for i in range(len(caption.split())-1):
                    ...
                    if total_count >= batch_size:
                        ...
                        partial_captions = sequence.pad_sequences(
                            partial_captions, maxlen=self.max_length, padding='post')
                        total_count = 0
